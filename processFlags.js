  ...
  portalEntries: () => {
    if (module.exports.portal && configName === 'clearblade-hot-reload') {
      ...
      if (fs.existsSync(configPath)) {
        ...
        console.error(chalk.red(`Missing src path: ${configPath}. To resolve this issue, create a 'src' directory in the root directory of this system and add a new file to it with the relative path of the target widget's .js parser file in the portal directory.`));
        throw new Error();
      }
    }
  }
